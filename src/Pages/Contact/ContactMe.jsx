...
function ContactMe() {
    ...
    const sendEmail = (e) => {
        ...
        const templateparams = {
            from_name: email,
            name: name,
            to_name: "G Prasad Bhat",
            feedback: message,
        }
        emailjs.send("service_waphowb", "template_r890zol", templateparams, "OoenAQXx9fd3-C_MU")
                    ...
                    <div className="contact-me-card row">
                        <div className="col-lg-6 col-md-5 col-sm-12 left-contact px-2 py-2">
                            ...
                            <span className="profile-links">
                                <Link href="https://github.com/gprasadbhat948231" isExternal><i className="fa-brands fa-github"></i></Link>
                                <Link href="https://www.linkedin.com/in/g-prasad-bhat-1b1345155/" isExternal><i className="fa-brands fa-linkedin"></i></Link>
                            </span>
                            <span className="profile-det">
                                <h1>Email: <span style={{color:'#fffb00'}}>gprasadbhat948231@gmail.com</span></h1>
                                <h1>Contact no: <span style={{color:'#fffb00'}}>9482318954</span></h1>
                            </span>
